...
def clean_name(name):
    name = str(name).strip()
    # Reemplazos para estandarizar nombres
    replacements = {
        ...
        'Congo': 'RD Congo',           # Normalizar Congo a RD Congo
...
# Limpiar nombres en el archivo de cruces
...
# Verificar que todos los equipos de los cruces tengan estadísticas
equipos_cruces = set()
...
# Eliminar filas con equipos no extraídos correctamente
...
print("🎯 CLASIFICADOS A OCTAVOS DE FINAL (GANADORES DE DIECISEISAVOS)")
for i, eq in enumerate(clasificados, 1):
    print(f"{i:2}. {eq}")

# ============================================================
# 8. (OPCIONAL) SIMULACIÓN MONTE CARLO PARA PORCENTAJES DE PASAR A OCTAVOS
# ============================================================

print("\n🔄 Calculando porcentajes de clasificación a octavos con simulación Monte Carlo (100 iteraciones)...")
...
print("\n📌 CLASIFICADOS A OCTAVOS (PREDICCIÓN DETERMINISTA)")
...
print("   - Estimación de xG con distribución de Poisson")
